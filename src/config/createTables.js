...
async function createTables(){
    ...
    const sql = `
    CREATE TABLE cliente (cliente_id SERIAL PRIMARY KEY, nome VARCHAR(255) NOT NULL, data_nascimento DATE NOT NULL, numero_documento VARCHAR(20) NOT NULL, genero VARCHAR(10) NOT NULL, numero_telefone VARCHAR(20) NOT NULL, status VARCHAR(7) NOT NULL, email VARCHAR(255) NOT NULL, senha VARCHAR(10) NOT NULL);
      
    INSERT INTO public.cliente (nome,data_nascimento,numero_documento,genero,numero_telefone, status, email, senha) VALUES ('João Silva','1985-03-14','123.456.789-00','Masculino','(11) 99999-9999', 'ATIVO', 'joaosilva@gmail.com', '123456');

    INSERT INTO public.cliente (nome,data_nascimento,numero_documento,genero,numero_telefone, status, email, senha) VALUES ('Fulano da Silva','1998-01-19','123.456.789-00','Masculino','(11) 99999-9999', 'INATIVO', 'fulanodaSilva@outlook.com', '123456');
      
    INSERT INTO public.cliente (nome,data_nascimento,numero_documento,genero,numero_telefone, status, email, senha) VALUES ('Rosa Laura da Mota','1993-03-06','969.474.187-47','Feminino','(27) 98250-1022', 'ATIVO', 'rosalaura@gmail.com', '123456');

    INSERT INTO public.cliente (nome,data_nascimento,numero_documento,genero,numero_telefone, status, email, senha) VALUES ('Lais Nair Joana Dias','1994-03-02','899.841.760-02','Feminino','(11) 99886-82232', 'INATIVO', 'laisdias@outlook.com', '123456');
